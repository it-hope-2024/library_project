...
<header class="z-40 bg-gray-100" >
    <nav  >
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button data-collapse-toggle="navbar-solid-bg" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm bg-gray-300 text-gray-100 rounded-lg md:hidden hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400  " aria-controls="navbar-solid-bg" aria-expanded="false">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
          <ul class="flex flex-col font-medium mt-4 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 text-gray-600 ">
            <!-- <li>
              <a href="#" class="block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:text-blue-700 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">Home</a>
            </li>
            <li>
            ...
            <li>
              <a href="/damascus" class="block py-2 px-3 rounded">Damascus</a>
            </li>
            <li>
                <a href="/aleppo" class="block py-2 px-3 rounded">Aleppo</a>
              </li>
              <li>
                <a href="/latakia" class="block py-2 px-3 rounded">Latakia</a>
              </li>
          </ul>
        </div>
      </div>
