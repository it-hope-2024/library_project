    ...
    <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <a href="#" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('assets/images/library-book.svg') }}" class="h-8" alt="Logo" />
        ...
        <span class="block text-sm text-gray-600 sm:text-center ">© 2025 <a href="#" class="hover:underline">Library Center</a>. All Rights Reserved.</span>
    </div>
</footer>
